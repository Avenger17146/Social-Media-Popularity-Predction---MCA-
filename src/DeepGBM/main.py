...
parser.add_argument('-data', type = str, default = 'npys')
...
parser.add_argument('-plot_title', type = str, default = 'plot')
...
parser.add_argument('-maxleaf', type = int, default = 100)
parser.add_argument('-mindata', type = int, default = 40)
parser.add_argument('-tree_lr', type = float, default = 0.1)
...
parser.add_argument('-feature_emb_size', type = int, default = 80)
...
def main():
    if "gbdt2nn" in args.model:
        num_data = dh.load_data(args.data)
